#!/usr/bin/env bash
# https://github.com/community-scripts/ProxmoxVE/commit/695802152856a8bd011ad060a70082dd1cf91ead
...
function update_script() {
    ...
    mv /opt/actualbudget /opt/actualbudget_bak # mv actualbudget
    mv actualbudget-actual-server-*/* /opt/actualbudget/ # try to move things inside it
