...
skip=904
CRCsum=3522757934
MD5=0fc1c52a36814b358af3fcf8c697f5f8
label="NVIDIA Accelerated Graphics Driver for Linux-x86_64 270.41.19"
version_string=270.41.19
pkg_version=0
script=./nvidia-installer
targetdir=NVIDIA-Linux-x86_64-270.41.19
scriptargs=""
keep=n
add_this_kernel=n
apply_patch=n
...
if [ "$1" = "-help" -o "$1" = "--help" -o "$1" = "-h" ]; then
    ...
    echo "for Linux-x86_64 270.41.19 by unpacking the embedded tarball and"
...
Package history for NVIDIA-Linux-x86_64-270.41.19-no-compat32:

NVIDIA-Linux-x86_64-270.41.19-no-compat32: Initial package

NVIDIA-Linux-x86_64-270.41.19: Added 32 bit compatibility libraries
...
if [ "$1" = "--info" ]; then
    ...
    echo "  Uncompressed size : 148784 KB"
    echo "  Compression       : gzip"
    echo "  Date of packaging : Tue May 17 00:41:32 PDT 2011"
