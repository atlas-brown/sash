...
def test_parse_shell_script_uses_libdash_for_bin_sh(tmp_path, monkeypatch):
...
def test_parse_shell_script_uses_shfmt_bridge_for_bin_bash(tmp_path, monkeypatch):
    monkeypatch.delenv("SASH_PARSER_BACKEND", raising=False)
...
def test_parse_shell_script_uses_shfmt_bridge_for_env_bash(tmp_path, monkeypatch):
    monkeypatch.delenv("SASH_PARSER_BACKEND", raising=False)
