...
BENCHMARK_NAMES = {
    ...
    "web_forums/claude2": "Claude Code home wipe",
    "web_forums/claude3": "Claude Code temp-file cleanup",
    "web_forums/claude4": "Claude Code null-output redirect",
    "web_forums/claude5": "Claude Code build cleanup",
    "web_forums/claude6": "Claude Code Next.js cleanup",
    ...
    "web_forums/find_rm": "find -exec rm accident",
    ...
    "web_forums/xargs_accident_rm": "xargs rm pipeline",
    "web_forums/xargs_del_files": "xargs mv delete",
}
